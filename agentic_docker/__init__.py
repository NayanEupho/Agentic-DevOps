# agentic_docker/__init__.py
"""
Agentic Docker Package Initialization

This file initializes the agentic_docker package and provides convenient
...
# Optional: Define what gets imported when someone does "from agentic_docker import *"
__all__ = [
    "run_command",
    "start_server",
    "process_query",
...
"""
import agentic_docker
print(agentic_docker.get_version())  # "1.0.0"
info = agentic_docker.get_package_info()
print(info['name'])  # "agentic_docker"
"""