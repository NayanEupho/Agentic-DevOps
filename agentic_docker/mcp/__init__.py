# agentic_docker/mcp/__init__.py
"""
...
# Define what gets imported when someone does "from agentic_docker.mcp import *"
__all__ = [
    "start_mcp_server",
    "call_tool", 
    "test_connection"
...
# Example usage:
"""
from agentic_docker.mcp import start_mcp_server, call_tool
